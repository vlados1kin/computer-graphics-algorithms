...
public class LightRenderer
{
        ...
        int color)
    {
        ...
        foreach (var angle in angles)
        {
            ...
            Rasterizer.DrawLineBresenham(buffer, width, height, x, y, xEnd, yEnd, lightColor, 1);
        }

        Rasterizer.DrawLineBresenham(buffer, width, height, x, y, x, y, lightColor, 4);
        // Отрисовываем центральную точку (опционально)
        Rasterizer.DrawLineBresenham(buffer, width, height, x, y, x, y, lightColor, 3);
